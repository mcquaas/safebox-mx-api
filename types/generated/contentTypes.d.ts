...
export interface ApiAuthLogAuthLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::auth-log.auth-log'
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Enumeration<['pin', 'biometric', 'password']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    canReceiveEmergencyAlert: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    canViewSharedDocs: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    emergencyLogs: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDocumentCategoryDocumentCategory
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    systemCategory: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    emergencyLogs: Schema.Attribute.Relation<
      ...
      'api::emergency-log.emergency-log'
    >;
    emergencyOnly: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiEmergencyLogEmergencyLog
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contactNotified: Schema.Attribute.Relation<
      'manyToOne',
      'api::contact.contact'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentsShared: Schema.Attribute.Relation<
      'manyToMany',
      'api::document.document'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    documentCategories: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-category.document-category'
    >;
    documents: Schema.Attribute.Relation<'oneToMany', 'api::document.document'>;
